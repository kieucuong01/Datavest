...
def main() -> int:
    ...
    app.setdefault("DATAVEST_TRADING_AGENTS_ENABLED", "true")
    app.setdefault("DATAVEST_TRADING_AGENTS_SERVICE_URL", "http://127.0.0.1:8080")
    app.setdefault("DATAVEST_TRADING_AGENTS_CALLBACK_URL", "http://127.0.0.1:5100/api/internal/trading-agents/callback")
    app.setdefault("DATAVEST_TRADING_AGENTS_STATE_ROOT", "/opt/datavest/shared/data/trading-agents")
    app.setdefault("DATAVEST_TRADING_AGENTS_HOST", "127.0.0.1")
    app.setdefault("DATAVEST_TRADING_AGENTS_PORT", "8080")
    app.setdefault("DATAVEST_TRADING_AGENTS_SERVICE_SECRET", secrets.token_hex(32))
    app.setdefault("DATAVEST_TRADING_AGENTS_CALLBACK_SECRET", secrets.token_hex(32))
    app.setdefault("TRADINGAGENTS_LLM_PROVIDER", "deepseek")
    app.setdefault("TRADINGAGENTS_QUICK_THINK_LLM", app.get("DEEPSEEK_MODEL") or "deepseek-chat")
    app.setdefault("TRADINGAGENTS_DEEP_THINK_LLM", app.get("DEEPSEEK_MODEL") or "deepseek-reasoner")
