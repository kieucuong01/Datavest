...
export default {
  ...
  methods: {
    ...
    tabText (key) {
      const text = {
        closeThat: this.$t('multiTab.closeCurrent'),
        closeRight: this.$t('multiTab.closeRight'),
        closeLeft: this.$t('multiTab.closeLeft'),
        closeAll: this.$t('multiTab.closeOthers'),
        clear: this.$t('multiTab.clear'),
        lastTab: this.$t('multiTab.lastTab'),
        noLeft: this.$t('multiTab.noLeft'),
        noRight: this.$t('multiTab.noRight')
      }
      return text[key]
    },
    closeCurrentActive () {
