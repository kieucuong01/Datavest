<template>
  ...
  >
    <section class="deep-analysis-panel" :class="{ 'theme-dark': dark }" aria-live="polite">
      ...
      <div v-if="!run && isSupported" class="deep-analysis-empty">
...
export default {
  ...
  watch: {
    visible (isVisible) {
      if (isVisible) this.restorePolling()
