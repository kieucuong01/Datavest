...
@media (max-width: 640px) { .deep-analysis-context { flex-direction: column; gap: 10px; }.deep-analysis-context h3 { font-size: 18px; }.deep-analysis-provenance { justify-content: flex-start; }.deep-analysis-empty { min-height: 230px; padding: 28px 12px; }.report-history-list { max-height: 290px; }.report-history-item { align-items: flex-start; flex-direction: column; gap: 9px; }.report-history-item .ant-btn { width: 100%; min-height: 40px; }.deep-analysis-status-row { align-items: flex-start; flex-direction: column; }.deep-analysis-progress { grid-template-columns: 1fr; }.deep-analysis-progress .ant-btn { width: 100%; min-height: 44px; }.deep-analysis-stage-list { display: grid; grid-template-columns: 1fr; }.deep-analysis-stage { min-height: 32px; }.history-recovery-actions { display: grid; grid-template-columns: 1fr; width: 100%; }.history-recovery-actions .ant-btn { min-height: 44px; }.recovery-actions { display: grid; grid-template-columns: 1fr; }.recovery-actions .ant-btn { min-height: 44px; }.report-heading { align-items: flex-start; flex-direction: column; }.deep-analysis-report pre { max-height: 48vh; padding: 13px; font-size: 11px; }.deep-analysis-footer { align-items: stretch; flex-direction: column; }.deep-analysis-footer .ant-btn { min-height: 44px; } }
</style>
