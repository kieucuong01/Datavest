...
const locale = {
  ...
  "aiAssetAnalysis.copilot.welcomeTitle": "Control DataVest with plain language",
  ...
  "guest.commonData": "You are viewing shared market data. Sign in to use portfolios and personal tools.",
  "guest.lockedFeature": "Sign in to use this feature.",
  "guest.strategyLogin": "Sign in to create strategies",
  "guest.indicatorReadOnly": "Read-only chart",
  "guest.indicatorTitle": "Market chart & indicators",
  "guest.indicatorDescription": "Explore price, draw on the chart and use technical indicators for BTC, VNINDEX and gold without signing in.",
  "guest.asset": "Asset",
  "guest.timeframe": "Timeframe",
  "guest.indicatorNote": "Indicator changes last for this session only. Sign in to code, save and turn indicators into strategies.",
  ...
  "notice.event.login.title": "DataVest login alert · {reason}",
  ...
  "notice.event.profileTest.title": "DataVest notification test",
  ...
  "trading-assistant.form.localDeploymentHint": "IBKR are external trading interfaces that require local deployment of DataVest. Cloud SaaS mode is not supported. Please ensure you have installed and configured the trading software (TWS/IB Gateway or IB Gateway terminal) on your local machine.",
  ...
  "settings.commercialLicense.body": "DataVest is provided for personal study and research only. Any form of commercial use — including but not limited to running it as a public SaaS, reselling it, offering managed-trading services, paid advisory or fund-management products — requires a written commercial license from us beforehand. Unauthorized commercial deployments will be pursued through legal channels.",
  ...
  "aiSkills.subtitle": "Manage prompt skills, inspect system tools, and keep every AI workflow aligned with DataVest boundaries.",
  ...
  "agentTokens.description": "Issue and manage tokens that let external AI agents (Cursor, Claude Code, Codex, MCP, custom bots) call this DataVest instance through /api/agent/v1.",
  ...
  "globalMarket.vnStockHeatmap": "Vietnam Stocks",
  "globalMarket.goldHeatmap": "Gold (XAU)",
  ...
  "globalMarket.calendarFinnhubForbidden": "The current source cannot access the economic calendar endpoint. DataVest prefers Trading Economics free access and AkShare fallback.",
  ...
  "community.marketRiskTip": "Risk notice: indicators, strategies, and backtest data in the library are based on historical data and community sharing for learning and research only. They do not constitute investment advice. DataVest supports paper simulation only and does not place live orders.",
  ...
  "community.chartOnlyIndicatorHint": "Use indicators to inspect trends, signals, and zones. Convert to a strategy before backtesting or paper simulation.",
  ...
  "fastAnalysis.systemTitle": "DATAVEST AI",
  ...
  "trading-assistant.editor.docsIntroDesc": "These are the commonly used DataVest Strategy API V2 APIs and lifecycle hooks, so you can code and look up usage side by side.",
  ...
  "quickTrade.tpslRecordOnlyHint": "Note: TP/SL prices are saved in DataVest trade records only. They are not sent to the exchange as native TP/SL or trigger orders. Set exchange-side TP/SL on the exchange if you need that.",
  ...
  "profile.exchange.openAccountPromo": "DataVest exclusive signup — up to 20% commission rebate",
  ...
  "profile.exchange.localDeploymentHint": "This broker requires local deployment of DataVest to use.",
  "profile.exchange.desktopBrokersDisabledTitle": "IBKR disabled on this server",
  "profile.exchange.desktopBrokersDisabledFallback": "Deploy DataVest on your own machine or private server and install TWS, IB Gateway, or Alpaca.",
