        ...
        <div class="opinion-main" :data-label="$t('smartInsights.deepAnalysis')">
          ...
          <template v-else-if="researchReport(row)">
            <div class="decision-brief-grid">
              <div class="decision-brief-highlights">
                <div class="decision-highlight decision-highlight--recommendation">
                ...
                <div class="decision-highlight decision-highlight--horizon">
  ...
  methods: {
    ...
    decisionActionPlan (row) {
      ...
      return actions
        ...
        .filter(action => !/^(?:time horizon|khung thời gian)\s*:/iu.test(action))
        .filter(Boolean)
        .join(' ')
    },
...
.decision-brief-highlights { display: grid; grid-template-columns: minmax(0, .82fr) minmax(0, 1.18fr); gap: 8px; }.decision-highlight { display: grid; align-content: start; gap: 6px; min-width: 0; min-height: 72px; padding: 11px 12px; border: 1px solid var(--line); border-radius: 8px; background: var(--card); color: var(--ink); font-size: 12px; font-weight: 600; line-height: 1.42; }.decision-highlight--recommendation { border-color: var(--blue); box-shadow: inset 3px 0 0 var(--blue); background: var(--soft-blue); }.decision-highlight--recommendation .decision-brief-rating { min-height: 30px; padding: 3px 11px; font-size: 13px; }.decision-highlight--horizon strong { font-size: 13px; line-height: 1.35; }.decision-brief-action-copy { margin: 0; color: var(--ink); font-weight: 600; line-height: 1.5; }.opinion-actions .ant-btn { width: 100%; min-width: 0; overflow: visible; text-overflow: clip; }
.decision-brief-grid { grid-template-columns: 1fr; }.decision-brief-actions { grid-column: auto; }
...
@media (max-width: 680px) {
  ...
  .decision-brief-grid { grid-template-columns: 1fr; gap: 6px; }.decision-brief-highlights { grid-template-columns: 1fr; gap: 6px; }.decision-highlight, .decision-brief-actions { padding: 8px; }.decision-highlight { min-height: 64px; }.opinion-row .opinion-actions { display: grid; grid-template-columns: 1fr; gap: 8px; justify-content: stretch; width: 100%; padding-top: 12px; border-top: 1px solid var(--line); }.opinion-row .opinion-actions .ant-btn { width: 100%; min-height: 44px; font-size: 12px; }
}
