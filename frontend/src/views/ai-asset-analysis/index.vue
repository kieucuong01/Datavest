        ...
        <div class="radar-track" :class="{ paused: oppHover }" :style="oppTrackStyle">
          ...
          >
            ...
            <div class="rc-metrics">
              <div class="rc-metric">
                <span class="rc-metric-label">{{ $t('aiAssetAnalysis.metric.price') }}</span>
                <span class="rc-metric-value">${{ formatOppPrice(opp.price) }}</span>
              </div>
              <div class="rc-metric">
                <span class="rc-metric-label">{{ $t('aiAssetAnalysis.metric.change24h') }}</span>
                <span class="rc-metric-value" :class="opp.change_24h >= 0 ? 'rc-up' : 'rc-down'">
                  {{ opp.change_24h >= 0 ? '+' : '' }}{{ (opp.change_24h || 0).toFixed(2) }}%
                </span>
              </div>
              <div class="rc-metric">
                <span class="rc-metric-label">{{ $t('aiAssetAnalysis.metric.signal') }}</span>
