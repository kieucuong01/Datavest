                ...
                <div class="chart-panel-toolbar">
                  <div class="chart-panel-toolbar-top">
                    ...
                    <div class="chart-panel-toolbar-top-actions">
                      ...
                      >
                        <a-icon type="bell" />
                        <span>{{ $t('indicatorIde.notification') }}</span>
      ...
      <div class="publish-form publish-market-form">
        ...
        <a-alert type="success" show-icon>
          <template slot="message">
            {{ $t('community.free') }} · {{ $t('community.codeVisible') }}
          </template>
        </a-alert>
  ...
  computed: {
    ...
    signalAlertWatchlistOptions () {
      ...
      if (!exists && this.symbol) {
        list.unshift({ market: this.market, symbol: this.symbol, name: '' })
      }
      return list
    },
  ...
  methods: {
    ...
    buildIndicatorToStrategyContext () {
      ...
      return {
        ...
        instrument_id: this.currentInstrumentId || '',
        timeframe: this.timeframe || '',
        sourceVisible: !this.selectedIndicatorCodeHidden
      }
    },
    ...
    getMarketColor (m) {
      const colors = { Crypto: 'orange', USStock: 'blue', VNStock: 'magenta', Forex: 'green' }
