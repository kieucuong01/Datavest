...
| Repository | [QuantDinger](https://github.com/OpenByteInc/QuantDinger) — self-hosted quant stack for research, strategies, backtests, Indicators, and paper portfolios |
...
- Capital movement, user account access, and external-order controls are outside the agent environment.
...
### 5.2 Capital and external execution

- Order placement, transfers, and user account secrets are not exposed through Agent or MCP flows.
