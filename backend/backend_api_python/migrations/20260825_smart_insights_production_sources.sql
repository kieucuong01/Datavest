...
VALUES
    ...
    ('cbbi-public', 'Colin Talks Crypto Bitcoin Bull Run Index', 'crypto', 'https://colintalkscrypto.com/cbbi/', 'SCRAPING', 'cbbi-v1', 2880, TRUE, 'IMPORT_ONLY', '2026-08-17', NULL, '{"schedule":"daily","activationMode":"IMPORT_ONLY"}'::jsonb),
