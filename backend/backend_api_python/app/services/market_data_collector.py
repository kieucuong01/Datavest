...
class MarketDataCollector:
    ...
    def _get_cn_hk_fundamental(self, market: str, symbol: str) -> Optional[Dict[str, Any]]:
        # Retired market adapter kept as a private compatibility stub only;
        # CN/HK fundamentals are no longer part of the supported product.
        return None
        # The legacy implementation below is intentionally unreachable.
        """
