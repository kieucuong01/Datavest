...
def _monitor_report_texts(language: str = "") -> Dict[str, str]:
    texts = {
        ...
        "subtitle": "Generated by DataVest Fast AI Analysis Engine",
    ...
    overrides = {
        "zh-CN": {
            "title": "AI 定时分析报告", "subtitle": "由 DataVest 快速 AI 分析引擎生成", "kicker": "定时 AI 监控",
        ...
        "zh-TW": {
            "title": "AI 定時分析報告", "subtitle": "由 DataVest 快速 AI 分析引擎生成", "kicker": "定時 AI 監控",
        ...
        "vi": {
            "title": "Báo cáo phân tích danh mục bằng AI", "subtitle": "Được tạo bởi hệ thống phân tích AI DataVest", "kicker": "Theo dõi AI định kỳ",
            "overview": "Tổng quan danh mục", "positions": "Số tài sản", "total_value": "Giá trị hiện tại", "total_cost": "Giá vốn",
            "total_pnl": "Lãi/lỗ tạm tính", "watchlist": "Danh sách theo dõi", "monitor_type": "Loại theo dõi", "latest_price": "Giá mới nhất",
            "not_applicable": "Không áp dụng", "ai_recommendations": "Phân bố nhận định AI", "buy": "Tích cực", "sell": "Tiêu cực", "hold": "Trung lập",
            "position_analysis": "Phân tích tài sản", "current_price": "Giá hiện tại", "entry_price": "Giá vốn", "pnl": "Lãi/lỗ",
            "quantity": "Số lượng", "side": "Chiều vị thế", "long": "Mua", "short": "Bán", "ai_decision": "Nhận định AI",
            "confidence": "Độ tin cậy", "reasoning": "Tóm tắt", "trader_report": "Phân tích giao dịch", "risk_report": "Đánh giá rủi ro",
            "overview_report": "Tổng quan thị trường", "click_expand": "Mở rộng để xem", "user_focus": "Nội dung người dùng quan tâm",
            "generated_at": "Thời điểm tạo", "disclaimer": "Chỉ dùng cho mục đích nghiên cứu, không phải tư vấn đầu tư.", "analysis_failed": "Phân tích thất bại",
        },
    }
...
def _bump_monitor_schedule(
    ...
    same monitor every 30 seconds while the underlying condition (no data,
