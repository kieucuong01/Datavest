...
def get_indicator_authoring_contract() -> Dict[str, Any]:
    ...
    return {
        ...
        "workflow": [
            ...
            "5. If the user wants a backtest, use the separate Indicator-to-Strategy workflow. Do not add execution behavior to indicator code.",
        ],
        "required_fields": {
        ...
        "forbidden": [
            ...
            "Strategy lifecycle or execution handlers",
