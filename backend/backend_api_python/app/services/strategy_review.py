...
_VI_REVIEW_COPY = {
    "Sample is still small": "Mẫu dữ liệu hiện còn ít",
    "Fewer than 5 closed trades have realised PnL in the selected window. Treat conclusions as directional.": "Có ít hơn 5 giao dịch đã đóng có lãi lỗ thực tế trong khoảng thời gian chọn. Chỉ nên xem kết luận là định hướng.",
    "Fewer than 5 closed trades have realised PnL in the selected review window. Treat the conclusion as directional.": "Có ít hơn 5 giao dịch đã đóng có lãi lỗ thực tế trong khoảng thời gian xem xét. Chỉ nên xem kết luận là định hướng.",
    "Collect more closed trades": "Tích lũy thêm giao dịch đã đóng",
    "Keep the report in observe mode until the strategy has at least 10-20 closed trades.": "Tiếp tục theo dõi cho đến khi chiến lược có ít nhất 10–20 giao dịch đã đóng.",
    "Recent realised PnL is negative": "Lãi lỗ thực tế gần đây đang âm",
    "Review-window realised PnL is negative": "Lãi lỗ thực tế trong khoảng xem xét đang âm",
    "The strategy lost money after fees in the selected window.": "Chiến lược bị lỗ sau phí trong khoảng thời gian đã chọn.",
    "Reduce risk before expanding capital": "Giảm rủi ro trước khi tăng vốn",
    "Do not increase leverage or capital until the next backtest/OOS check improves expectancy.": "Không tăng đòn bẩy hoặc vốn cho đến khi lần kiểm thử tiếp theo cho thấy kỳ vọng được cải thiện.",
    "Do not increase leverage or capital until the next backtest or out-of-sample check improves expectancy.": "Không tăng đòn bẩy hoặc vốn cho đến khi lần kiểm thử hoặc kiểm định ngoài mẫu tiếp theo cho thấy kỳ vọng được cải thiện.",
    "Profit factor is below 1": "Profit factor thấp hơn 1",
    "Winning trades are not covering losing trades and fees.": "Các giao dịch có lãi chưa đủ bù giao dịch thua lỗ và chi phí.",
    "Review entry and exit filters": "Rà soát bộ lọc vào và thoát lệnh",
    "Check whether entries are too early, exits are too late, or the strategy is being used in the wrong market regime.": "Kiểm tra xem vào lệnh có quá sớm, thoát lệnh có quá muộn hay chiến lược đang được dùng trong trạng thái thị trường không phù hợp.",
    "Win rate is low": "Tỷ lệ thắng đang thấp",
    "The strategy is losing more often than expected. This can be acceptable only when average wins are much larger than losses.": "Chiến lược thua thường xuyên hơn kỳ vọng. Điều này chỉ có thể chấp nhận khi mức lãi trung bình lớn hơn nhiều mức lỗ.",
    "The strategy loses more often than it wins. This is only acceptable when average wins are much larger than losses.": "Chiến lược thua nhiều hơn thắng. Điều này chỉ có thể chấp nhận khi mức lãi trung bình lớn hơn nhiều mức lỗ.",
    "Tighten signal quality": "Nâng ngưỡng chất lượng tín hiệu",
    "Consider adding trend, volatility, or volume confirmation before new entries.": "Cân nhắc bổ sung xác nhận xu hướng, biến động hoặc khối lượng trước khi vào lệnh mới.",
    "Drawdown is elevated": "Mức sụt giảm đang cao",
    "Performance drawdown is elevated": "Sụt giảm theo hiệu suất đang cao",
    "The realised equity path shows a meaningful peak-to-trough drop.": "Đường vốn thực tế cho thấy mức giảm đáng kể từ đỉnh xuống đáy.",
    "The performance-page equity path shows a meaningful peak-to-trough drop.": "Đường vốn trên trang hiệu suất cho thấy mức giảm đáng kể từ đỉnh xuống đáy.",
    "Cap position size": "Giới hạn quy mô vị thế",
    "Lower entry percentage or maximum position while this strategy is under review.": "Giảm tỷ lệ vào lệnh hoặc vị thế tối đa trong thời gian xem xét chiến lược.",
    "Consecutive losses detected": "Phát hiện chuỗi thua liên tiếp",
    "The strategy had a losing streak that can pressure margin and operator confidence.": "Chiến lược có chuỗi thua gây áp lực lên ký quỹ và sự tự tin khi vận hành.",
    "Add a cooldown after loss streaks": "Thêm thời gian tạm nghỉ sau chuỗi thua",
    "Consider pausing new entries after 3 consecutive realised losses until the next confirmed setup.": "Cân nhắc tạm dừng lệnh mới sau 3 giao dịch thua liên tiếp cho đến khi có thiết lập được xác nhận.",
    "Fees are material": "Chi phí giao dịch đang đáng kể",
    "Commissions are large compared with realised PnL, so small edges may be erased.": "Hoa hồng lớn so với lãi lỗ thực tế nên lợi thế nhỏ có thể bị chi phí xóa mất.",
    "Reduce churn or improve execution": "Giảm tần suất giao dịch hoặc cải thiện khớp lệnh",
    "Use fewer but higher-quality signals, maker orders where appropriate, or wider grid spacing.": "Dùng ít tín hiệu hơn nhưng chất lượng cao hơn, dùng lệnh maker khi phù hợp hoặc tăng khoảng cách lưới.",
    "Some grid matches closed below net profit": "Một số cặp lưới đóng dưới mức lợi nhuận ròng",
    "Grid matched rows include negative net PnL after fees.": "Một số cặp lưới có lãi lỗ ròng âm sau phí.",
    "Check grid spacing versus fees": "Kiểm tra khoảng cách lưới so với chi phí",
    "Increase grid spacing or lower trading frequency so each matched pair covers both entry and exit fees.": "Tăng khoảng cách lưới hoặc giảm tần suất giao dịch để mỗi cặp lưới bù được phí vào và thoát lệnh.",
    "Many entries are not closed yet": "Nhiều lệnh vào vẫn chưa được đóng",
    "The trade log has more opens than exits in the selected window.": "Nhật ký giao dịch có nhiều lệnh mở hơn lệnh đóng trong khoảng thời gian đã chọn.",
    "The trade log has more opens than exits in the selected review window.": "Nhật ký giao dịch có nhiều lệnh mở hơn lệnh đóng trong khoảng xem xét đã chọn.",
    "Review accumulated exposure": "Rà soát mức phơi nhiễm tích lũy",
    "Make sure the strategy is intentionally scaling in and that max position limits are active.": "Đảm bảo việc tăng vị thế là có chủ đích và giới hạn vị thế tối đa đang hoạt động.",
    "Open positions are present": "Hiện còn vị thế mở",
    "The report includes unrealized PnL, but final performance is not locked until positions close.": "Báo cáo có lãi lỗ chưa thực hiện, nhưng hiệu suất cuối cùng chưa thể chốt cho đến khi vị thế được đóng.",
    "Window PnL and performance return differ": "Lãi lỗ trong khoảng xem xét khác lợi nhuận hiệu suất",
    "The selected review window can be profitable while the full performance equity curve remains negative.": "Khoảng xem xét có thể có lãi trong khi đường vốn toàn bộ theo hiệu suất vẫn âm.",
    "No obvious issue in this window": "Chưa thấy vấn đề rõ ràng trong khoảng này",
    "The deterministic checks did not find a clear risk concentration. Continue monitoring sample size and out-of-sample drift.": "Các kiểm tra theo quy tắc chưa phát hiện điểm tập trung rủi ro rõ ràng. Tiếp tục theo dõi quy mô mẫu và độ lệch ngoài mẫu.",
    "Keep monitoring": "Tiếp tục theo dõi",
    "No automatic parameter change is recommended from this sample alone.": "Không nên tự động thay đổi tham số chỉ dựa trên mẫu dữ liệu này.",
}


def _review_text(en: str, zh: str, language: str) -> str:
    if str(language or "").lower().replace("_", "-").startswith("vi"):
        return _VI_REVIEW_COPY.get(en, en)
...
class StrategyReviewService:
    ...
    def _legacy_build_rule_review(
        ...
        *,
        ...
        def text(en: str, zh: str) -> str:
            return _review_text(en, zh, language)
        ...
        if not diagnostics:
            diag("success", "no_major_issue",
                 ...
                 text("The deterministic checks did not find a clear risk concentration. Continue monitoring sample size and out-of-sample drift.",
    ...
    def _legacy_build_ai_review(self, *, base_report: Dict[str, Any], language: str) -> Dict[str, Any]:
        ...
        language_norm = str(language or "").lower()
        is_zh = language_norm.startswith("zh")
        is_vi = language_norm.startswith("vi")
        ...
        if is_zh:
            ...
            default["summary"] = "Bản xem xét được tạo từ các giao dịch và chỉ số định lượng trong kỳ đã chọn."
            default["diagnosis"] = [f"Hệ thống ghi nhận {len(diagnostics)} điểm cần xem xét theo các quy tắc định lượng."]
            default["recommendations"] = ["Kiểm tra lại các điều kiện vào lệnh, thoát lệnh và giới hạn rủi ro trước khi thay đổi tham số."]
            default["cautions"] = ["Bản xem xét này không tự động thay đổi tham số chiến lược."]
        else:
        ...
        try:
            ...
            system_prompt += " " + language_instruction(language, structured=True)
            if is_zh_tw:
        ...
        *,
        ...
        if not diagnostics:
            diag(
                ...
                text("No obvious issue in this window", "当前周期未发现明显异常"),
                text(
                    "The deterministic checks did not find a clear risk concentration. Continue monitoring sample size and out-of-sample drift.",
                    "规则检查没有发现明显风险集中点，建议继续观察样本量和实盘偏差。",
                ),
                None,
            )
    ...
    def _build_ai_review(self, *, base_report: Dict[str, Any], language: str) -> Dict[str, Any]:
        ...
        if is_vi:
            default.update({
                "summary": "Bản xem xét được tạo từ giao dịch, vị thế và các chỉ số định lượng.",
                "diagnosis": [f"Hệ thống ghi nhận {len(diagnostics)} điểm cần xem xét theo các quy tắc định lượng."],
                "recommendations": ["Kiểm tra các điều kiện vào lệnh, thoát lệnh và giới hạn rủi ro trước khi thay đổi tham số."],
                "cautions": ["Bản xem xét này không tự động thay đổi tham số chiến lược."],
            })
