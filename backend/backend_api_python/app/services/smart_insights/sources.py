...
def _source(
    ...
    return SourceDefinition(
        ...
        methodology,
        terms,
        code in PRODUCTION_VERIFIED_SOURCE_CODES,
...
_SOURCE_ROWS = (
    ...
    _source("bitinfocharts-top-addresses", "BitInfoCharts Richest Bitcoin Addresses", "crypto", "SCRAPING", ("https://bitinfocharts.com/top-100-richest-bitcoin-addresses.html",), "daily", "bitinfocharts-v1", 2880, "https://bitinfocharts.com/top-100-richest-bitcoin-addresses.html"),
    ...
    _source("mempool-space", "mempool.space", "crypto", "API", ("https://mempool.space/api/v1/fees/recommended", "https://mempool.space/api/mempool", "https://mempool.space/api/v1/mining/hashrate/3y"), "daily", "mempool-v1", 1440, "https://mempool.space/about"),
