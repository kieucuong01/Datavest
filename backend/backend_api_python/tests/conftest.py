...
os.environ.setdefault("DATAVEST_SMART_INSIGHTS_ENABLED", "true")
os.environ.setdefault("DATAVEST_PORTFOLIO_OPTIMIZER_ENABLED", "true")
os.environ.setdefault("DATAVEST_COMMUNITY_ENABLED", "true")
