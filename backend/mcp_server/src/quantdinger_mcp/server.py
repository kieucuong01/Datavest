...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "redacted (***) secret placeholders; do not attempt to recover them. "
        ...
        "save_strategy_source before backtesting. Source versions can be "
...
def list_paper_orders() -> Any:
    """Recent paper portfolio orders (scope R)."""
