...
scp @scpArgs $archive $checksum (Join-Path $repo 'deploy/vps/deploy.sh') (Join-Path $repo 'deploy/vps/configure_env.py') (Join-Path $repo 'deploy/vps/datavest-celery.service') (Join-Path $repo 'deploy/vps/datavest-crypto-insights-browser.service') (Join-Path $repo 'deploy/vps/datavest-trading-agents.service') "${target}:/opt/datavest/incoming/"
